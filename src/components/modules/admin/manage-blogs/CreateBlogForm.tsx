...
const CreateBlogForm = () => {
  ...
  const [editorContent, setEditorContent] = useState(""); // ✅ Fix state for ReactQuill
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-[#0C0A09] text-muted-foreground">
      <div className="w-full ">
        <h1 className="text-center text-2xl text-[#748195] mb-6">
          Create Blog
        </h1>
        ...
        >
          <div>
            <Label htmlFor="name" className="text-[#748195]">
              Blog Name
            </Label>
            <Input
              id="name"
          ...
          <div>
            <Label htmlFor="imageUrl" className="text-[#748195]">
              Image URL
            </Label>
            <Input
              id="imageUrl"
          ...
          <div className="md:col-span-2">
            <Label htmlFor="description" className="text-[#748195]">
              Description
            </Label>
            <ReactQuill
              value={editorContent}
          ...
          <div className="md:col-span-2 mt-8">
            <Button
              type="submit"
              disabled={loading}
              className="bg-white w-full lg:w-fit text-black py-2 px-4 rounded-lg hover:bg-white hover:text-black"
            >
