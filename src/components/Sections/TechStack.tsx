...
import { FaReact, FaNodeJs, FaGitAlt, FaCcStripe, FaTrello } from "react-icons/fa";
import { SiNextdotjs, SiJavascript, SiTypescript, SiTailwindcss, SiHtml5, SiCss3, SiJsonwebtokens, SiMongodb, SiPostman, SiFigma, SiAdobephotoshop, SiCanva } from "react-icons/si";
...
const TechStack = () => {
  return (
    <TooltipProvider>
      <section id="TechStack" className="pt-20 px-6 sm:px-12 text-white">
        <h1 className="text-center text-4xl mb-4">Tech Stack</h1>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-6 text-4xl">
            {[
              ...
              <Tooltip key={index}>
                <TooltipTrigger className="cursor-pointer">{tech.icon}</TooltipTrigger>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-6 text-4xl">
            {[
              ...
              { icon: <TbBrandRedux className="text-blue-600" />, label: "Redux" },
              { icon: <SiAxios className="text-white" />, label: "Axios" },
              { icon: <SiReactquery className="text-orange-300" />, label: "TanStack Query" },
              { icon: <SiTailwindcss className="text-teal-400" />, label: "Tailwind CSS" },
              { icon: <SiShadcnui className="text-teal-400" />, label: "Shadcn Ui" },
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-6 text-4xl">
            {[
              ...
              { icon: <IoLogoFirebase className="text-orange-500" />, label: "Firebase" },
              { icon: <SiJsonwebtokens className="text-yellow-500" />, label: "JWT" },
              { icon: <SiMongodb className="text-green-500" />, label: "MongoDB" },
              { icon: <SiCloudinary className="text-indigo-500" />, label: "Cloudinary" },
              { icon: <SiPostman className="text-orange-600" />, label: "Postman" },
              { icon: <FaCcStripe className="text-indigo-500" />, label: "Stripe" }
            ].map((tech, index) => (
              <Tooltip key={index}>
                <TooltipTrigger className="cursor-pointer">{tech.icon}</TooltipTrigger>
                <TooltipContent>{tech.label}</TooltipContent>
        ...
        <div className="mb-6">
          <h2 className="text-xl font-semibold mb-3">Developer & Design Tools</h2>
          <div className="flex flex-wrap gap-6 text-4xl">
            {[
              { icon: <VscVscode className="text-blue-400" />, label: "VS Code" },
              { icon: <IoLogoVercel className="text-white" />, label: "VS Code" },
              { icon: <FaGitAlt className="text-red-500" />, label: "Git & GitHub" },
              { icon: <SiFigma className="text-pink-500" />, label: "Figma" },
              { icon: <FaTrello className="text-blue-300" />, label: "Trello" },
              { icon: <SiAdobephotoshop className="text-blue-600" />, label: "Adobe Photoshop" },
              { icon: <SiCanva className="text-cyan-500" />, label: "Canva" },
            ].map((tool, index) => (
              <Tooltip key={index}>
                <TooltipTrigger className="cursor-pointer">{tool.icon}</TooltipTrigger>
